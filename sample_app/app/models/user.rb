class User < ApplicationRecord
  ...
  has_many :passive_relationships, class_name: "Relationship",
                                  ...
                                  dependent: :destroy
  has_many :followers, through: :passive_relationships, source: :follower #sourceは参照先を表す※今回省略可能なぜなら↓
            #followers属性なら自動的に外部キー'follower_id'を探してくれるから=>foreign_keyと一致するため
